...
function longest(words, idx = 0, currLong = 0) {
  if (idx === words.length) return currLong;
  currLong = Math.max(words[idx].length, currLong);
  return longest(words, idx + 1, currLong);
}
